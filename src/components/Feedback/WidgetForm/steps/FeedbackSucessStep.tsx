...
export function FeedbackSucessStep({
    ...
    return (
        ...
        <div className="flex flex-col items-center py-10  w-[304px]">
            ...
            className="py-2 px-6 mt-6 bg-green-500 rounded-md border-transparent text-sm text-white leading-6 hover:bg-green-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-900 focus:ring-green-500"> 
            Quero enviar outro
            </button>
        </div>
        </>
